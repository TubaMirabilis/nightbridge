    ...
    <>
      ...
      <main>
        ...
        <div className="d-none d-lg-block container">
          <p className="text-center fs-4 mb-5" style={{letterSpacing: "0.125rem"}}>THE HOME OF NIGHTBRIDGE ON THE WEB WITH OUR LATEST NEWS, LIVE CONCERT SCHEDULE, VIDEOS, PUBLICITY IMAGES AND MORE!</p>
        </div>
        <Externals />
        <Upcoming />
      </main>
